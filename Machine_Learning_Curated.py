...
AccelerometerTrustedZone_node1688102900198 = (
    glueContext.create_dynamic_frame.from_options(
        ...
        format="json",
        connection_options={
            "paths": ["s3://olaitans3bucket/accelerometer/trusted/"],
            "recurse": True,
        },
...
CustomerTrustedZone_node1688782334053 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://olaitans3bucket/Customer/trusted/"],
        "recurse": True,
    },
...
StepTrainerTrustedZone_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://olaitans3bucket/step_trainer/trusted/"],
        "recurse": True,
    },
...
MachineLearningZone_node3 = glueContext.getSink(
    path="s3://olaitans3bucket/machine_learning/curated/",
    connection_type="s3",
    updateBehavior="LOG",
    partitionKeys=[],
